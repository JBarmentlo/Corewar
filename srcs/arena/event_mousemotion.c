...
/*   Updated: 2020/03/09 10:56:49 by ncoursol         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		event_motion_players2(t_disp *d, int *timeout, int i, int ph)
{
	...
	|| d->pause == 1))
	{
		...
		&& SDL_SetRenderDrawColor(d->rend, 255, 0, 255, 155) < 0)
			error("(event_mousemotion.c) SDL_SetRenderDrawColor : ", d);
